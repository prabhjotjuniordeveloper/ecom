      ...
      <div className="page-content">
        <div className="container">
          ...
          <div className="accordion accordion-rounded" id="accordion-1">
            ...
            {/* More FAQ items follow the same structure */}
            <div className="card card-box card-sm bg-light">
              ...
              <div id="collapse-2" className="collapse" aria-labelledby="heading-2" data-parent="#accordion-1">
                <div className="card-body">
                  Ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.
                </div>
              </div>
            </div>
            <div className="card card-box card-sm bg-light">
