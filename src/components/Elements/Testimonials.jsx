...
const Testimonials = () => {
  ...
  <div className="page-header text-center" style={{backgroundImage: 'url("assets/images/page-header-bg.jpg")'}}>
    <div className="container">
      <h1 className="page-title">Testimonials<span>Elements</span></h1>
    </div>{/* End .container */}
  </div>{/* End .page-header */}
  ...
  <div className="page-content">
    <div className="container">
      <h2 className="title text-center mb-3">Quote Sign <span className="title-separator">/</span> Centered Align</h2>{/* End .title text-center */}
      <div className="owl-carousel owl-theme owl-testimonials" data-toggle="owl" data-owl-options="{
                      &quot;nav&quot;: false, 
                      &quot;dots&quot;: true,
                      &quot;margin&quot;: 20,
                      &quot;loop&quot;: true,
      ...
      <h2 className="title text-center mb-3">Quote Sign <span className="title-separator">/</span> Centered Align <span className="title-separator">/</span> 2 Columns</h2>{/* End .title text-center */}
      <div className="owl-carousel owl-theme owl-testimonials" data-toggle="owl" data-owl-options="{
                      &quot;nav&quot;: false, 
                      &quot;dots&quot;: true,
                      &quot;margin&quot;: 20,
      ...
      <hr className="mt-5 mb-5" />
      <h2 className="title text-center mb-3">Quote Sign <span className="title-separator">/</span> Centered Align <span className="title-separator">/</span> 3 Columns</h2>{/* End .title text-center */}
      <div className="owl-carousel owl-theme owl-testimonials" data-toggle="owl" data-owl-options="{
                      &quot;nav&quot;: false, 
                      &quot;dots&quot;: true,
                      &quot;margin&quot;: 20,
    ...
    <div className="bg-image bg-overlay pt-5 pb-4" style={{backgroundImage: 'url(assets/images/backgrounds/bg-1.jpg)'}}>
      <div className="container">
        <h2 className="title text-center text-white mb-3">Quote Sign <span className="title-separator">/</span> Centered Align <span className="title-separator">/</span> Dark Background</h2>{/* End .title text-center */}
        <div className="owl-carousel owl-theme owl-testimonials owl-light" data-toggle="owl" data-owl-options="{
                          &quot;nav&quot;: false, 
                          &quot;dots&quot;: true,
                          &quot;margin&quot;: 20,
                          &quot;loop&quot;: true,
    ...
    <div className="mb-5" />{/* End .mb-5 */}
    <div className="container">
      <h2 className="title text-center mb-3">Customer Photo <span className="title-separator">/</span> Centered Align</h2>{/* End .title text-center */}
      <div className="owl-carousel owl-theme owl-testimonials-photo" data-toggle="owl" data-owl-options="{
                      &quot;nav&quot;: false, 
                      &quot;dots&quot;: true,
                      &quot;margin&quot;: 20,
                      &quot;loop&quot;: false,
      ...
      <hr className="mt-5 mb-5" />
      <h2 className="title text-center mb-3">Customer Photo <span className="title-separator">/</span> Centered Align <span className="title-separator">/</span> 2 Columns</h2>{/* End .title text-center */}
      <div className="owl-carousel owl-theme owl-testimonials-photo" data-toggle="owl" data-owl-options="{
                      &quot;nav&quot;: false, 
                      &quot;dots&quot;: true,
                      &quot;margin&quot;: 20,
