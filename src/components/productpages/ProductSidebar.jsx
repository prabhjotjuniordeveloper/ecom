              ...
              <div className="col-md-6">
                <div className="product-gallery">
                  ...
                  <div id="product-zoom-gallery" className="product-image-gallery">
                    <Link className="product-gallery-item active" href="#" data-image="assets/images/products/single/sidebar-gallery/1.jpg" data-zoom-image="assets/images/products/single/sidebar-gallery/1-big.jpg">
                      <img src="assets/images/products/single/sidebar-gallery/1-small.jpg" alt="product side" />
                    </Link>
                    <Link className="product-gallery-item" href="#" data-image="assets/images/products/single/sidebar-gallery/2.jpg" data-zoom-image="assets/images/products/single/sidebar-gallery/2-big.jpg">
                      <img src="assets/images/products/single/sidebar-gallery/2-small.jpg" alt="product cross" />
                    </Link>
                    <Link className="product-gallery-item" href="#" data-image="assets/images/products/single/sidebar-gallery/3.jpg" data-zoom-image="assets/images/products/single/sidebar-gallery/3-big.jpg">
                      <img src="assets/images/products/single/sidebar-gallery/3-small.jpg" alt="product with model" />
                    </Link>
                    <Link className="product-gallery-item" href="#" data-image="assets/images/products/single/sidebar-gallery/4.jpg" data-zoom-image="assets/images/products/single/sidebar-gallery/4-big.jpg">
                ...
                <div className="product-details product-details-sidebar">
                  ...
                  <div className="details-filter-row details-row-size">
                    ...
                    <div className="product-nav product-nav-dots">
                      ...
                      <Link to="#" style={{background: '#efe7db'}}><span className="sr-only">Color name</span></Link>
                    </div>{/* End .product-nav */}
          ...
          <div className="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options="{
            ...
            <div className="product product-7 text-center">
              ...
              <div className="product-body">
                ...
                <h3 className="product-title"><Link to="product.html">Brown paperbag waist pencil skirt</Link></h3>{/* End .product-title */}
                <div className="product-price">
                  $60.00
                </div>{/* End .product-price */}
                <div className="ratings-container">
            ...
            <div className="widget widget-products">
              ...
              <div className="products">
                <div className="product product-sm">
                  ...
                  <div className="product-body">
                    <h5 className="product-title"><Link to="product.html">Light brown studded Wide fit wedges</Link></h5>{/* End .product-title */}
                    <div className="product-price">
                ...
                <div className="product product-sm">
                  ...
                  <div className="product-body">
                    <h5 className="product-title"><Link to="product.html">Yellow button front tea top</Link></h5>{/* End .product-title */}
                    <div className="product-price">
                      $56.00
                    </div>{/* End .product-price */}
                  </div>{/* End .product-body */}
                ...
                <div className="product product-sm">
                  ...
                  <div className="product-body">
                    <h5 className="product-title"><Link to="product.html">Beige metal hoop tote bag</Link></h5>{/* End .product-title */}
                    <div className="product-price">
                      $50.00
                    </div>{/* End .product-price */}
                  </div>{/* End .product-body */}
                ...
                <div className="product product-sm">
                  ...
                  <div className="product-body">
                    <h5 className="product-title"><Link to="product.html">Black soft RI weekend travel bag</Link></h5>{/* End .product-title */}
                    <div className="product-price">
                      $75.00
                    </div>{/* End .product-price */}
                  </div>{/* End .product-body */}
              ...
              <Link to="category.html" className="btn btn-outline-dark-3"><span>View More Products</span><i className="icon-long-arrow-right" /></Link>
